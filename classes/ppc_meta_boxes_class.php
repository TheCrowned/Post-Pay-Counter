...
class PPC_meta_boxes {
    ...
    static function meta_box_counting_settings( $post, $current_settings ) {
        ...
        echo PPC_HTML_functions::echo_p_field( __( 'Apply shortcodes', 'post-pay-counter' ), $current_settings['counting_words_apply_shortcodes'], 'checkbox', 'counting_words_apply_shortcodes', __( 'Shortcodes will be appleid before counting words.', 'post-pay-counter') );
